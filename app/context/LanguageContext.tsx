...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    companyIntro: "CV. Berkah Ryan yang berdiri sejak tahun 2023 bergerak di bidang jasa penyewaan alat berat dengan fokus utama penyewaan crane berkapasitas 3 hingga 600 ton.",
    ...
    companyMisiText: "Memberikan pelayanan persewaan alat berat yang unggul dengan fokus pada persewaan crane berkapasitas 3 hingga 600 ton, serta berkomitmen dalam menyediakan peralatan berkualitas dan pelayanan terbaik kepada klien dari berbagai industri.",
    ...
    craneSec1Title: "01. Telescopic Mobile Crane",
    craneSec1Desc: "Penyewaan Telescopic Mobile Crane di Banten untuk kebutuhan konstruksi, logistik, dan infrastruktur. Crane mobile ini menawarkan fleksibilitas tinggi di jalan raya dan mobilitas cepat antar lokasi kerja. Dilengkapi boom teleskopik hidrolik yang tangguh untuk pengangkatan presisi tinggi.",
    craneSec1Text: "Tadano (25, 80 Ton), Sany (25 Ton), Kato (50, 160 Ton), Liebherr (200 Ton), Sumitomo (360 Ton), Demag (600 Ton)",
    craneSec2Title: "02. Truck Mounted Crane",
    craneSec2Desc: "Layanan sewa Truck-Mounted Crane berkapasitas 3 hingga 16 ton. Sangat ideal untuk medan semi-offroad, area perkotaan yang padat, atau proyek dengan ruang gerak terbatas yang membutuhkan manuver lincah dan setup cepat.",
    craneSec2Text: "Tadano (3, 5, 8 Ton), Unic (10, 16 Ton)",
    craneSec3Title: "03. Crawler Crane",
    craneSec3Desc: "Sewa Crawler Crane kelas berat (45 - 550 Ton) untuk proyek infrastruktur berskala besar, erection girder jembatan, pembangunan pabrik, dan industri petrokimia di Cilegon dan Banten. Menggunakan lintasan rantai baja kokoh yang memberikan kestabilan maksimal di permukaan tanah lunak.",
    craneSec3Text: "Link Belt (45 Ton), Sumitomo (60 Ton), P&H (150 Ton), Manitowoc (200 Ton), Demac (400 Ton), Kobelco (550 Ton)",
    craneSec4Title: "04. Roughter Crane",
    craneSec4Desc: "Penyewaan Rough Terrain Crane (Roughter) berkapasitas 25 hingga 110 ton untuk mobilitas tangguh di medan proyek ekstrem berlumpur dan tidak rata. Memiliki ban tapak lebar dan sistem kemudi 4x4 (four-wheel drive) yang ideal untuk tahap awal konstruksi sipil.",
    craneSec4Text: "Tadano (25, 50, 80 Ton), Kato (45, 110 Ton)",
    ...
    forkliftSec1Desc: "Sewa Forklift Cilegon Banten kapasitas 3 hingga 35 ton untuk bongkar muat material pabrik, logistik gudang, dan pemindahan mesin industri. Unit terawat dengan pilihan sewa harian, mingguan, maupun bulanan beserta operator berpengalaman.",
    forkliftSec1Text: "TCM (3, 5, 10 Ton), Daewoo / Mitsubishi (15, 25, 35 Ton)",
    ...
    homeServicesCraneDesc: "Sewa mobile crane, crawler crane, roughter crane kapasitas 3 - 600 Ton bersertifikasi K3 Kemnaker untuk kebutuhan pengangkatan presisi.",
    homeServicesCraneAlt: "Penyewaan Crane Cilegon Banten - CV Berkah Ryan",
    homeServicesForkliftTitle: "Penyewaan Forklift",
    homeServicesForkliftDesc: "Jasa rental forklift kapasitas 3 hingga 35 Ton untuk bongkar muat material pabrik, logistik gudang, dan pemindahan mesin.",
  ...
  en: {
    ...
    companyIntro: "Established in 2023, CV. Berkah Ryan operates in the heavy equipment rental services industry, focusing primarily on cranes ranging from 3 to 600 tons.",
    ...
    companyMisiText: "To deliver outstanding heavy equipment rental services centered on cranes ranging from 3 to 600 tons, while remaining dedicated to providing certified machinery and top-tier technical support to diverse industrial clients.",
    ...
    craneSec1Title: "01. Telescopic Mobile Crane",
    craneSec1Desc: "Telescopic Mobile Crane rental in Banten for construction, logistics, and infrastructure needs. These mobile cranes offer high road flexibility and rapid deployment between jobsites, featuring robust hydraulic telescopic booms for precise heavy lifting.",
    craneSec1Text: "Tadano (25, 80 Ton), Sany (25 Ton), Kato (50, 160 Ton), Liebherr (200 Ton), Sumitomo (360 Ton), Demag (600 Ton)",
    craneSec2Title: "02. Truck Mounted Crane",
    craneSec2Desc: "Truck-Mounted Crane rental ranging from 3 to 16 tons. Ideal for semi-offroad terrains, tight urban environments, or confined spaces requiring high maneuverability and rapid setup.",
    craneSec2Text: "Tadano (3, 5, 8 Ton), Unic (10, 16 Ton)",
    craneSec3Title: "03. Crawler Crane",
    craneSec3Desc: "Heavy-duty Crawler Crane rental (45 to 550 Tons) for large-scale infrastructure projects, bridge girder erection, industrial plant assembly, and petrochemical complexes in Cilegon and Banten. Engineered with steel crawler tracks for maximum stability on soft ground conditions.",
    craneSec3Text: "Link Belt (45 Ton), Sumitomo (60 Ton), P&H (150 Ton), Manitowoc (200 Ton), Demac (400 Ton), Kobelco (550 Ton)",
    craneSec4Title: "04. Roughter Crane",
    craneSec4Desc: "Rough Terrain Crane (Roughter) rental ranging from 25 to 110 tons for outstanding mobility on extreme, muddy, and uneven terrains. Equipped with oversized tires and 4x4 four-wheel drive steering, perfect for early-stage civil construction sites.",
    craneSec4Text: "Tadano (25, 50, 80 Ton), Kato (45, 110 Ton)",
    ...
    forkliftSec1Title: "05. Forklift",
    forkliftSec1Desc: "Forklift rental in Cilegon Banten with capacities ranging from 3 to 35 tons for industrial material handling, warehouse logistics, and heavy machinery relocation. Well-maintained units available for daily, weekly, or monthly rental with experienced operators.",
    forkliftSec1Text: "TCM (3, 5, 10 Ton), Daewoo / Mitsubishi (15, 25, 35 Ton)",
    forkliftSec2Title: "06. Trailer",
    ...
    homeServicesCraneDesc: "Rent mobile cranes, crawler cranes, roughter cranes from 3 to 600 Tons with official K3 certification for precision heavy lifting.",
    homeServicesCraneAlt: "Crane Rental Cilegon Banten - CV Berkah Ryan",
    homeServicesForkliftTitle: "Forklift Rental Services",
    homeServicesForkliftDesc: "Forklift rental ranging from 3 to 35 Tons for warehouse logistics, plant loading, and industrial machinery relocation.",
